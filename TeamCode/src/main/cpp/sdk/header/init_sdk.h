...
#define init_sdk        env->GetJavaVM(&sdk::jvm);                                                                                                                                   \
                        ...
                        sdk::WebcamName = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass("org/firstinspires/ftc/robotcore/external/hardware/camera/WebcamName")));                                                                                                                                                             \
                        sdk::CameraName = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass("org/firstinspires/ftc/robotcore/external/hardware/camera/CameraName")));                                                                                                                                                             \
