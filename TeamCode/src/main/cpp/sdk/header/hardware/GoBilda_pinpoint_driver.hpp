...
namespace sdk
{
    ...
    public:
        ...
        constexpr static const char *device_status_to_string(Device_status status)
        {
            switch (status)
            {
        ...
        constexpr static const char *encoder_direction_to_string(const Encoder_direction &direction)
        {
            switch (direction)
            {
        ...
        constexpr static const char *goBilda_odometry_pods_to_string(const GoBilda_odometry_pods &pods)
        {
            switch (pods)
            {
        ...
        constexpr static const char *read_data_to_string(const read_data &data)
        {
            switch (data)
            {
         ...
         */
        void update(const read_data &data) const;
         ...
         */
        void set_offsets(const double &x_offset, const double &y_offset) const;
         ...
         */
        void set_encoder_directions(const Encoder_direction &x_encoder, const Encoder_direction &y_encoder) const;
         ...
         */
        void set_encoder_resolution(const GoBilda_odometry_pods &pods) const;
         ...
         */
        void set_encoder_resolution(const double &ticks_per_mm) const;
         ...
         */
        void set_yaw_scalar(const double &yaw_offset) const;
         ...
         */
        void set_position(const Pose2D &pos) const;
         ...
         */
        int get_device_version() const;

        float get_yaw_scalar() const;
         ...
         */
        Device_status get_device_status() const;
         ...
         */
        double get_heading_velocity() const;
