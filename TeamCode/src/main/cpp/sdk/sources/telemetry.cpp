...
namespace sdk::telemetry
{
    ...
    bool update()
    {
        attach_thread return env->CallBooleanMethod(telemetry, env->GetMethodID(jclazz, "update", "()Z"));
    }
    ...
    void speak(const string &text, const string &language_code, const string &country_code)
    {
        ...
        env->CallVoidMethod(telemetry, env->GetMethodID(jclazz, "speak", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"),
    ...
    string get_caption()
    {
        attach_thread auto jstr = (jstring)(env->CallObjectMethod(telemetry,
    ...
    void set_display_format(const Display_format &display_format)
    {
        ...
        env->CallVoidMethod(telemetry, env->GetMethodID(jclazz, "setDisplayFormat", "(Lorg/firstinspires/ftc/robotcore/external/Telemetry$DisplayFormat;)V"),
                            displayFormat);
    ...
    void set_item_separator(const string &item_separator)
    {
        ...
        env->DeleteLocalRef(env->CallObjectMethod(telemetry, env->GetMethodID(jclazz, "setItemSeparator", "(Ljava/lang/String;)V"),
                                                  jitem_separator));
    ...
    void set_caption_value_separator(const string &caption_value_separator)
    {
        ...
        env->DeleteLocalRef(env->CallObjectMethod(telemetry, env->GetMethodID(jclazz, "setCaptionValueSeparator", "(Ljava/lang/String;)V"),
    ...
    bool is_auto_clear()
    {
        attach_thread return env->CallBooleanMethod(telemetry,
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(telemetry, env->GetMethodID(jclazz,
    ...
    bool is_retained()
    {
        attach_thread return static_cast<bool>(env->CallBooleanMethod(telemetry, env->GetMethodID(jclazz,
                                                                                                  "isRetained",
                                                                                                  "()Z")));
    }
