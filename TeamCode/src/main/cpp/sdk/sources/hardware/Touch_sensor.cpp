...
#include "hardware/Touch_sensor.hpp"
...
namespace sdk
{
    ...
    Touch_sensor &Touch_sensor::operator=(const Touch_sensor &touch_sensor)
    {
        ...
        {
            attach_thread this->touchSensor = env->NewGlobalRef(touch_sensor.touchSensor);
        }
        return *this;
    }
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(touchSensor,
    ...
    {
        attach_thread return env->CallBooleanMethod(touchSensor,
