...
#include "hardware/camera/Webcam_name.hpp"
...
namespace sdk
{
    ...
    {
        attach_thread auto jstr = (jstring)(env->CallObjectMethod(webcamName,
    ...
    {
        attach_thread return env->CallBooleanMethod(webcamName,
