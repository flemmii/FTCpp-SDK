...
#include "hardware/camera/Camera_name.hpp"
...
namespace sdk
{
    ...
    Camera_name &Camera_name::operator=(const Camera_name &camera_name)
    {
        ...
        {
            attach_thread this->cameraName = env->NewGlobalRef(camera_name.cameraName);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(cameraName, env->GetMethodID(jclazz, "isWebcam", "()Z"));
    }

    bool Camera_name::is_camera_direction() const
    {
        attach_thread return env->CallBooleanMethod(cameraName,
    ...
    {
        attach_thread return env->CallBooleanMethod(cameraName, env->GetMethodID(jclazz, "isUnknown", "()Z"));
    }
} // sdk