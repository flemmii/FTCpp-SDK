...
#include "hardware/Dc_motor_simple.hpp"
...
namespace sdk
{
    ...
    Dc_motor_simple &Dc_motor_simple::operator=(const Dc_motor_simple &dc_motor_simple)
    {
        ...
        {
            attach_thread this->dcMotorSimple = env->NewGlobalRef(dc_motor_simple.dcMotorSimple);
        }
        return *this;
    }
    ...
    void Dc_motor_simple::set_direction(const Direction &direction) const
    {
        ...
        env->CallVoidMethod(dcMotorSimple, env->GetMethodID(jclazz, "setDirection", "(Lcom/qualcomm/robotcore/hardware/DcMotorSimple$Direction;)V"),
                            jdirection);
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(dcMotorSimple,
