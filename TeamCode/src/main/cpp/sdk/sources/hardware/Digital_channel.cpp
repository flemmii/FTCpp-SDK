...
#include "hardware/Digital_channel.hpp"
...
namespace sdk
{
    ...
    Digital_channel &Digital_channel::operator=(const Digital_channel &digital_channel)
    {
        ...
        {
            attach_thread this->digitalChannel = env->NewGlobalRef(digital_channel.digitalChannel);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(digitalChannel,
