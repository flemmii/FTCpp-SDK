...
#include "hardware/Analog_input.hpp"
...
namespace sdk
{
    ...
    Analog_input &Analog_input::operator=(const Analog_input &analog_input)
    {
        ...
        {
            attach_thread this->analogInput = env->NewGlobalRef(analog_input.analogInput);
        }
        return *this;
    }
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(analogInput,
    ...
    {
        attach_thread auto jStr = (jstring)(env->CallObjectMethod(analogInput,
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(analogInput,
