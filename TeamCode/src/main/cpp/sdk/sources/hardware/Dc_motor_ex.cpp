...
namespace sdk
{
    ...
    {
        attach_thread return env->CallBooleanMethod(dcMotorEx,
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(dcMotorEx,
    ...
    PIDF_coefficients Dc_motor_ex::get_PIDF_coefficients(const Run_mode &mode) const
    {
        ...
        jobject coefficients = env->CallObjectMethod(dcMotorEx, env->GetMethodID(jclazz, "getPIDFCoefficients", "(Lcom/qualcomm/robotcore/hardware/DcMotor$RunMode;)Lcom/qualcomm/robotcore/hardware/PIDFCoefficients;"),
                                                     RunMode);
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(dcMotorEx,
                                                                 env->GetMethodID(jclazz,
    ...
    void Dc_motor_ex::set_current_alert(const double &current) const
    {
        ...
        env->CallVoidMethod(dcMotorEx, env->GetMethodID(jclazz, "getCurrentAlert", "(D;Lorg/firstinspires/ftc/robotcore/external/navigation/CurrentUnit;)V"),
    ...
    {
        attach_thread bool result = env->CallBooleanMethod(dcMotorEx,
