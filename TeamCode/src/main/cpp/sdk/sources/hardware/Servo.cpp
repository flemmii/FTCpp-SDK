...
namespace sdk
{
    ...
    Servo &Servo::operator=(const Servo &servo)
    {
        ...
        {
            attach_thread this->servo = env->NewGlobalRef(servo.servo);
        }
        return *this;
    }
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(servo,
    ...
    void Servo::set_direction(const Direction &direction) const
    {
        ...
        env->CallVoidMethod(servo, env->GetMethodID(jclazz, "setDirection", "(Lcom/qualcomm/robotcore/hardware/Servo$Direction;)V"),
                            jdirection);
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(servo,
