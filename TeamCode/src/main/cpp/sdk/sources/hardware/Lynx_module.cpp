...
#include "hardware/Lynx_module.hpp"
...
namespace sdk
{
    ...
    Lynx_module &Lynx_module::operator=(const Lynx_module &lynx_module)
    {
        ...
        {
            attach_thread this->lynxModule = env->NewGlobalRef(lynx_module.lynxModule);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(lynxModule,
    ...
    void Lynx_module::set_bulk_caching_mode(const Bulk_caching_mode &bulk_caching_mode) const
    {
        ...
        env->CallVoidMethod(lynxModule, env->GetMethodID(jclazz, "setBulkCachingMode", "(Lcom/qualcomm/hardware/lynx/LynxModule$BulkCachingMode;)V"),
                            bulkCachingMode);
