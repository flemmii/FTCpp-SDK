...
namespace sdk
{
    ...
    Light_sensor &Light_sensor::operator=(const Light_sensor &light_sensor)
    {
        ...
        {
            attach_thread this->lightSensor = env->NewGlobalRef(light_sensor.lightSensor);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallDoubleMethod(lightSensor,
    ...
    {
        attach_thread auto jstr = (jstring)env->CallObjectMethod(lightSensor, env->GetMethodID(jclazz, "status",
                                                                                               "()Ljava/lang/String;"));
