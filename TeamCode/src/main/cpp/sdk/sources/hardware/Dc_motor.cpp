...
namespace sdk
{
    ...
    Dc_motor &Dc_motor::operator=(const Dc_motor &dc_motor)
    {
        Dc_motor_simple::operator=(dc_motor);
        this->dcMotor = Dc_motor_simple::dcMotorSimple;
        return *this;
    }
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(dcMotor, env->GetMethodID(jclazz,
                                                                                           "getPortNumber",
                                                                                           "()I")));
    }
    ...
    void Dc_motor::set_mode(const Run_mode &mode) const
    {
        ...
        env->CallVoidMethod(dcMotor, env->GetMethodID(jclazz, "setMode", "(Lcom/qualcomm/robotcore/hardware/DcMotor$RunMode;)V"),
                            runMode);
    ...
    void Dc_motor::set_zero_power_behavior(const Zero_power_behavior &zero_power_behavior) const
    {
        ...
        env->CallVoidMethod(dcMotor, env->GetMethodID(jclazz, "setZeroPowerBehavior", "(Lcom/qualcomm/robotcore/hardware/DcMotor$ZeroPowerBehavior;)V"),
                            zeroPowerBehavior);
    ...
    {
        attach_thread return static_cast<int>(env->CallIntMethod(dcMotor,
                                                                 env->GetMethodID(jclazz,
                                                                                  "getTargetPosition",
                                                                                  "()I")));
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(dcMotor,
