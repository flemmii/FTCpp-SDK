...
#include "hardware/Gyro_sensor.hpp"
...
namespace sdk
{
    ...
    Gyro_sensor &Gyro_sensor::operator=(const Gyro_sensor &gyro_sensor)
    {
        ...
        {
            attach_thread this->gyroSensor = env->NewGlobalRef(gyro_sensor.gyroSensor);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(gyroSensor,
                                                    env->GetMethodID(jclazz, "isCalibrating", "()Z"));
    }

    int Gyro_sensor::get_heading() const
    {
        attach_thread return static_cast<int>(env->CallIntMethod(gyroSensor,
    ...
    {
        attach_thread return static_cast<double>(env->CallDoubleMethod(gyroSensor, env->GetMethodID(jclazz,
                                                                                                    "getRotationFraction",
                                                                                                    "()D")));
    }
    ...
    {
        attach_thread auto jstr = (jstring)(env->CallObjectMethod(gyroSensor,
