...
#include "hardware/Modern_robotics_color_beacon.hpp"
...
namespace sdk
{
    ...
    Modern_robotics_color_beacon::Modern_robotics_color_beacon(
        const jobject &modernRoboticsColorBeacon) : modernRoboticsColorBeacon(modernRoboticsColorBeacon) {}
        ...
        const Modern_robotics_color_beacon &modern_robotics_color_beacon)
    {
        ...
        {
            attach_thread this->modernRoboticsColorBeacon = env->NewGlobalRef(
                modern_robotics_color_beacon.modernRoboticsColorBeacon);
        }
        return *this;
    }
    ...
    {
        attach_thread return env->CallBooleanMethod(modernRoboticsColorBeacon,
                                                    env->GetMethodID(jclazz, "doInitialize", "()Z"));
    }

    std::string Modern_robotics_color_beacon::get_device_name() const
    {
        attach_thread auto jstr = (jstring)env->CallObjectMethod(modernRoboticsColorBeacon,
